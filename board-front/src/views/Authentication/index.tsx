...
import { SignInRequestDto, SignUpRequestDto } from 'apis/requeset/auth';
...
export default function Authentication() {
    ...
    const SignInCard = () => {
        ...
        const signInResponse = (responseBody: SignInResponseDto | ResponseDto | null) => {
            ...
            if (code === 'VF') alert('Please enter all required information.');
                ...
                <div className='auth-card-box'>
                    <div className='auth-card-top'>
                        <div className='auth-card-title-box'>
                            <div className='auth-card-title-login'>{'로그인'}</div>
                        </div>
                    ...
                    <div className='auth-card-top'>
                        ...
                        {page === 2 && (
                            <>
                                ...
                                <InputBox ref={addressDetailRef} label='상세주소' type='text' placeholder='상세 주소를 입력해주세요.' value={addressDetail} onChange={onAddressDetailChangeHandler} error={false} onKeyDown={onAddressDetailKeyDownHandler} />
                            </>
                        )}

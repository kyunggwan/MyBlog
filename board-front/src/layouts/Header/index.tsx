...
import { PatchBoardRequestDto, PostBoardRequestDto } from "apis/requeset/board";
import {
...
export default function Header() {
  ...
  const SearchButton = () => {
    ...
    const { searchWord } =
      useParams(); /* App.tsx에 작성된 부분과 동일하게 searchWord로 함 */

    //              event handler: 검색어 변경 이벤트 처리 함수                //
    const onSearchBoardChangeHandler = (
    ...
    return (
      <div className="header-search-input-box">
        <input
          ...
          value={word}
          onChange={onSearchBoardChangeHandler}
    ...
    <div id="header">
      <div className="header-container">
        <div className="header-left-box" onClick={onLogoClickHandler}>
          ...
          <div className="header-logo">{"Gwani Board"}</div>
        </div>

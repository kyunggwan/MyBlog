...
import { PostBoardRequestDto } from 'apis/requeset/board';
...
export default function Header() {
    ...
    const SearchButton = () => {
        ...
        //              state: 검색어 path varibale 상태                //
        const { searchWord } = useParams(); /* App.tsx에 작성된 부분과 동일하게 searchWord로 함 */
        ...
        return (
            <div className='header-search-input-box'>
                <input className='header-search-input' type='text' placeholder='검색어를 입력해 주세요.' value={word} onChange={onSearchBoardChangeHandler} onKeyDown={onSearchWordKeyDownHandler} />
                <div>
    ...
    const UploadButton = () => {
        ...
        const onUploadButtonClickHandler = async () => {
            ...
            for (const file of boardImgFileList) {
